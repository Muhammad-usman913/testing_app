                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            child: Text('Start\nfrom Scratch',style: TextStyle(fontSize: 24.sp,fontWeight: FontWeight.w500,color: Color(0xff030F09)),))
                      ],
                    ),
                  ),
                ],
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Create account to continue.',style: TextStyle(fontSize: 14,color: Color(0xff606060)),),
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(labelText: 'Full Name',labelStyle: TextStyle(color: Colors.grey), border: UnderlineInputBorder(
                    ...
                    Column(
                      children: [
                        Text('Already have an account?',style: TextStyle(color: Color(0xffA8A8A8),fontSize: 14.sp),),
                        SizedBox(height: 5.h,),
                        GestureDetector(
                          onTap: (){

                          },
                          child: Center(child: Text('Login Here',style: TextStyle(color: Color(0xff30BE76),fontSize: 16.sp,fontWeight: FontWeight.bold),)),
                        )
                      ],
                    )
